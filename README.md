...
It keeps the source layout, panels, Thought process sheet, controls, and assets, but replaces personal app logic with local demo handlers.

Public-safety notes:
- No personal chat records are included.
